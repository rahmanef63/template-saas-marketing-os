...
/**
 * CommentsSection — saas-marketing host skin for the reusable `comments` slice.
 *
 ...
 * to this template's convex `features/comments` functions and renders a simple
 * threaded skin (reply boxes nested by parentId). Mounted on the public blog
 * post detail page.
 */
