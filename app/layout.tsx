...
const DEFAULT_NAME = "SaaS Marketing OS";
const DEFAULT_DESC =
  "Launch-ready marketing site for SaaS products, indie hackers & startups — pricing + features, integrations + blog. Free template, clone-to-own.";
...
// template defaults when settings are unset or unreachable.
